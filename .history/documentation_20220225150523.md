...
With our videos merged, we can capture the processed canvas using a media stream to chunks of blob and pass the blob to the blob state hook created ealier. Remember to use the timeout method to set up number of s
