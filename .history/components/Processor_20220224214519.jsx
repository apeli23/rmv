...
export default function Processor() {
    let video, canvas, outputContext, tempCn, temporaryContext, video2;
    ...
    useEffect(() => {
        ...
        tempCn = document.createElement('canvas');
        tempCn.setAttribute('width', 800);
        tempCn.setAttribute('height', 450);
        temporaryContext = tempCn.getContext('2d');
