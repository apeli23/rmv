...
export default function Processor() {
    let video, canvas, outputContext, tempCnv, tempCtx, video2;
    ...
    useEffect(() => {
        ...
        tempCnv = document.createElement('canvas');
        tempCnv.setAttribute('width', 800);
        tempCnv.setAttribute('height', 450);
        tempCtx = tempCnv.getContext('2d');
    ...
    function computeFrame() {
        ...
        let frame = tempCtx.getImageData(0, 0, video.width, video.height);


        tempCtx.drawImage(video2, 0, 0, video2.width, video2.height);
        let frame2 = tempCtx.getImageData(0, 0, video2.width, video2.height);
