...
export default function Processor() {
    let video, canvas, outputContext, tempC, temporaryContext, video2;
    ...
    useEffect(() => {
        ...
        tempC.setAttribute('width', 800);
        tempC.setAttribute('height', 450);
        temporaryContext = tempC.getContext('2d');
